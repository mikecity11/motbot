...
export function aiConfigured(){return process.env.MOT_AI_ENABLED==='true'&&!!process.env.AI_GATEWAY_API_KEY&&!!process.env.MOT_AI_DATABASE_URL&&(process.env.MOT_AI_SESSION_SECRET?.length??0)>=32;}
